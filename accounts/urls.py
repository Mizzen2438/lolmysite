...
urlpatterns = [
    ...
    path("onboarding/riot/rso/login/", views.riot_rso_login, name="riot_rso_login"),
    path("onboarding/riot/rso/callback/", views.riot_rso_callback, name="riot_rso_callback"),
